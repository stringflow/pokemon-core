...
const GameData RED_DATA = { 
    ...
    .overworld_address = symbol_lookup_red("JoypadOverworld"),
...
const GameData BLUE_DATA = { 
    ...
    .overworld_address = symbol_lookup_blue("JoypadOverworld"),
...
const GameData YELLOW_DATA = { 
    ...
    .overworld_address = symbol_lookup_yellow("JoypadOverworld"),
...
const GameData GOLD_DATA = { 
    ...
    .overworld_address = symbol_lookup_gold("OWPlayerInput"),
...
const GameData SILVER_DATA = { 
    ...
    .overworld_address = symbol_lookup_silver("OWPlayerInput"),
...
const GameData CRYSTAL_DATA = { 
    ...
    .overworld_address = symbol_lookup_crystal("OWPlayerInput"),
